...
public class ItemStacks {
    ...
    public static ItemStack handHeldTON618() {
        ...
        ItemStack info = new ItemStack(Material.PLAYER_HEAD);
        SkullMeta meta = (SkullMeta) info.getItemMeta();
        meta.setDisplayName(ChatColor.DARK_PURPLE + "" + ChatColor.BOLD + "Hand Held TON 618");

        List<String> lore = new ArrayList<>();

        lore.add(ChatColor.WHITE + "" + ChatColor.BOLD + "Nappixel is better than Hypixel because the plugins");
        ...
        lore.add(ChatColor.WHITE + "" + ChatColor.BOLD + "On Hypixel you just know the game will work");
        lore.add(ChatColor.WHITE + "" + ChatColor.BOLD + "and that's boring...");
