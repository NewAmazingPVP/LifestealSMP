...
public class QuickMaths implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            //Bukkit.broadcastMessage(ChatColor.YELLOW + "If the drug cartel was in a boat going 120.214235kph bearing 190 and the wind was going at a content speed of 15.2kph bearing 230 plus 25 degrees, what is the magnitude and direction of the boat?
