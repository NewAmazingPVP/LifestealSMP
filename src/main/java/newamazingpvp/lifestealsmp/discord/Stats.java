...
public class Stats extends ListenerAdapter {
    ...
    private void processStats(String playerName, String channelId) {
        ...
        sendDiscordEmbedStats("Kills: " + kills + " ⚔️\nDeaths: " +
                ...
                + " blocks\nDamage Dealt: " + deal +
                "❤️\nTime Played: " + hours + " hours " + mins + " minutes", Color.BLUE, channelId, playerName);
    }

    public static SlashCommandData getSlashCommandData() {
        return Commands.slash("stats", "Get player statistics")
