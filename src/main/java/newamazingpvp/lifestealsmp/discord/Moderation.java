...
public class Moderation extends ListenerAdapter {
    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        if (shouldBeWarned(messageContent)) {
            sendDiscordMessage(event.getAuthor().getName() + " possibly tried saying something bad. Here is the flagged language " + messageContent.replace("@", ""), "1339042765425610803");
        }
