...
public class JumpBoostRune extends AbstractRune {
    ...
    private static final PotionEffect effect = new PotionEffect(PotionEffectType.JUMP, 200, 0);
    private static final PotionEffect effectII = new PotionEffect(PotionEffectType.JUMP, 200, 1);
