...
public class StrengthRune extends AbstractRune {
    ...
    private static final PotionEffect effect = new PotionEffect(PotionEffectType.INCREASE_DAMAGE, 120, 0);
    private static final PotionEffect effectII = new PotionEffect(PotionEffectType.INCREASE_DAMAGE, 120, 1);
