...
public class StrengthRune extends AbstractRune {
    ...
    private static final PotionEffect effect = new PotionEffect(PotionEffectType.STRENGTH, 120, 0);
    private static final PotionEffect effectII = new PotionEffect(PotionEffectType.STRENGTH, 120, 1);
