...
public class StrengthRune extends AbstractRune {
    ...
    private static final PotionEffect effect = new PotionEffect(PotionEffectType.STRENGTH, 100, 0);
    private static final PotionEffect effectII = new PotionEffect(PotionEffectType.STRENGTH, 100, 1);
