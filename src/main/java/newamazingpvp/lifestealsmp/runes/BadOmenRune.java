...
public class BadOmenRune extends AbstractRune {
    ...
    private static final EntityType mob = EntityType.VINDICATOR;
    private static final PotionEffect effect = new PotionEffect(PotionEffectType.BAD_OMEN, 200, 0);
    private static final PotionEffect effectII = new PotionEffect(PotionEffectType.BAD_OMEN, 200, 1);
    private static final PotionEffect effectIII = new PotionEffect(PotionEffectType.BAD_OMEN, 200, 2);
    private static final PotionEffect effectIV = new PotionEffect(PotionEffectType.BAD_OMEN, 200, 3);
    private static final PotionEffect effectV = new PotionEffect(PotionEffectType.BAD_OMEN, 200, 4);
