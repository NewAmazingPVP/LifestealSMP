package newamazingpvp.lifestealsmp.unused.events.corruptedmobs.mobs.engima.spawn;
...
public class SpawnEnigma {
    ...
    public SpawnEnigma(Location location) {
        ...
        enigmaZombie.setMetadata(CorruptedMobsMain.isCustomMobTag, CorruptedMobsMain.isCustomMob);
