package newamazingpvp.lifestealsmp.unused.events.corruptedmobs.mobs.bomber.spawn;

import newamazingpvp.lifestealsmp.unused.events.corruptedmobs.CorruptedMobsMain;
import newamazingpvp.lifestealsmp.unused.events.corruptedmobs.mobs.bomber.events.TntThrown;
...
public class SpawnBomber {
    ...
    public SpawnBomber(Location location) {
        ...
        mageZombie.setMetadata(CorruptedMobsMain.isCustomMobTag, CorruptedMobsMain.isCustomMob);
        ...
        bomberMobAttackRate = new BukkitRunnable() {
            ...
            public void run() {
                ...
                TntThrown.spawnBomberThrowable(mageZombie, bomberLoc, attackerLookDir);
