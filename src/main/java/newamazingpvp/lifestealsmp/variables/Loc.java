...
public class Loc {
    ...
    public static Location spawnLoc1 = new Location(Bukkit.getWorld("world"), Bukkit.getWorld("world").getSpawnLocation().getX()-100, -61, Bukkit.getWorld("world").getSpawnLocation().getX()-100);
    public static Location spawnLoc2 = new Location(Bukkit.getWorld("world"), Bukkit.getWorld("world").getSpawnLocation().getX()+100, 319, Bukkit.getWorld("world").getSpawnLocation().getX()+100);
